...
let money = prompt('Ваш ежемесячный доход?', 15000),
    ...
    monthlyRequiredCosts1 = prompt('Какие обязательные ежемесячные расходы у вас есть?',
                                    'Общественный транспорт, интернет'),
    amountOfExpenses1 = prompt('Во сколько это обойдется?', 3455),
    monthlyRequiredCosts2 = prompt('Какие ещё обязательные ежемесячные расходы у вас есть?', 'Кредит'),
    amountOfExpenses2 = prompt('Во сколько это обойдется?', 7938),
...
console.log(getExpensesMonth(amountOfExpenses1, amountOfExpenses2));

let accumulatedMonth;

function getAccumulatedMonth(money, amountOfExpenses1, amountOfExpenses2){
    accumulatedMonth = +money - (+amountOfExpenses1) - (+amountOfExpenses2);
    return accumulatedMonth;
}
getAccumulatedMonth(money, amountOfExpenses1, amountOfExpenses2);
